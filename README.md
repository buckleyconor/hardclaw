...
Files:
  ...
  shutdown.sh                 — Clean stack shutdown (run when done)
  gb10-cleanup.sh             - Reset GB10 back to pre-hardclaw state
...
Quick start:
  ...
  bash gb10-cleanup.sh        # reset GB10 to pre-hardclaw state
